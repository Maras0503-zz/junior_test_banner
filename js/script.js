...
window.onload = function () {
	...
	function frame1() {
		...
		_animationFactory(chooseYourReward, { alpha: 1 }, 0, 1000, false);
		_animationFactory(whenSwitch, { alpha: 1 }, 1000, 1000, false)
	...
	function frame2() {
		...
		_animationFactory(whenYouJoin, { alpha: 1 }, 0, 2000, false);
		_animationFactory(lineRental, { alpha: 1 }, 1000, 1000, false);
	...
	/**
	 * Functions to create sheen efect on button
	 */
	function blink() {
		...
		_animationFactory(shape, { alpha: 1 }, 0, 0, false);
		_animationFactory(shape, { x: 280, y: 190 }, 0, 600, false)
	 ...
	 * @param {boolean} sequence - specify if animation elements dispalayed in sequence
	 * @param {Function} callback - funtion that will be executed after animation
	 */
